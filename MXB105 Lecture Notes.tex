...
\begin{table}[H]
    ...
    \begin{tabular}{c c c c}
        ...
        \(\left(b^2x^2-a^2\right)^n\) & \(\displaystyle x=\frac{a}{b}\sec{\left( \theta \right)}\) & \(a^2\tan^2{\left( \theta \right)}\) & \(\theta\in \left[ 0,\: \frac{\pi}{2} \right) \cup \left(\frac{\pi}{2},\: \pi\right]\) \\ % chktex 9
        \bottomrule
    \end{tabular}
...
\begin{tcolorboxlarge}[title={Properties of Definite Integrals}]
    \begin{theorem}
        ...
        \(k\in\R\) then
        \begin{enumerate}[label=\normalfont\alph*)] % chktex 9 chktex 10
...
\begin{definition}
    ...
    nonnegative on a region \(\Omega\) in the \(xyz\)-space, then the
...
\begin{proof}
    ...
    points outside of \(\Omega\) are discarded. The volume of the

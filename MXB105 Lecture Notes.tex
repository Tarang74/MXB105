...
\begin{table}[H]
    ...
    \begin{tabular}{c | c | c}
        ...
        $\sin{\left( x \right)}$ & $\sum_{n=0}^{\infty} \frac{\left( -1 \right)^n}{\left( 2n+1 \right)!} x^{2n+1}$ & $-\infty < x < \infty$ \\
        $\cos{\left( x \right)}$ & $\sum_{n=0}^{\infty} \frac{\left( -1 \right)^n}{\left( 2n \right)!} x^{2n}$ & $-\infty < x < \infty$ \\

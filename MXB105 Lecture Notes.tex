...
\begin{table}[H]
    ...
    \begin{tabular}{c | c}
        ...
        \midrule
            ...
            $\left(ax+b\right)^k, \: k \in \mathbb{N}$ & $\displaystyle \frac{A_1}{ax+b} + \frac{A_2}{\left( ax+b \right)^2} + \cdots + \frac{A_k}{\left( ax+b \right)^k}$ \\
            $ax^2+bx+c$ & $\displaystyle \frac{A}{ax^2+bx+c}$ \\
            $\left(ax^2+bx+c\right)^k, \: k \in \mathbb{N}$ & $\displaystyle \frac{A_1x+B_1}{ax^2+bx+c} + \frac{A_2}{\left( ax+b \right)^2} + \cdots + \frac{A_k}{\left( ax+b \right)^k}$ \\
        \bottomrule
    \end{tabular}
...
\begin{theorem}[Differentiability]
    ...
    \begin{equation*}
        \dv{f}{x}\vert_{x=x_0} = \lim_{h\to 0} \frac{f(x_0+h)-f(x_0)}{h}
    \end{equation*}
\end{theorem}
\begin{theorem}
...
\begin{theorem}[Mean Value Theorem]
    ...
    \begin{equation*}
        \dv{f}{x}\vert_{x=c}=\frac{f(b)-f(a)}{b-a}
    \end{equation*}
\end{theorem}
\newpage
...
\begin{definition}[Interval of Convergence]
    The interval of convergence of a power series, is the set of $x$ values for which that series converges. 
\end{definition}
...
\begin{definition}[Finite Limit of Multivariable Functions using the $\varepsilon$-$\delta$ Definition]
    \begin{align*}
		&\lim_{(x,\: \ldots,\: x_n)\to (c_1,\: \ldots,\: c_n)} f(x_1,\: \ldots,\: x_n) = L \\ 
...
\begin{theorem}[Existence of a Limit]
    If the limit of $f(x,\: y)$ fails to exist as $(x,\: y) \to (x_0,\: y_0)$ along some smooth curve, or if $f(x,\: y)$ has different limits as $(x,\: y) \to (x_0,\: y_0)$, then $\displaystyle \lim_{(x,\: y) \to (x_0,\: y_0)}$ does not exist.
\end{theorem}
\begin{theorem}[Continuity of Multivariable Functions]
    A function $f(x_1,\: \ldots,\: x_n)$ is continuous at $(c_1,\: \ldots,\: c_n)$ iff
    \begin{equation*}
        \lim_{(x,\: \ldots,\: x_n)\to (c_1,\: \ldots,\: c_n)} f(x_1,\: \ldots,\: x_n) = f(c_1,\: \ldots,\: c_n)
    \end{equation*}
\end{theorem}
...
\begin{definition}[Partial Differentiation]
    ...
    \begin{equation*}
        \pdv{f}{x_i}\vert_{(c_1,\: \ldots,\: c_n)} = \lim_{h \to 0} \frac{f(x_1,\: \ldots,\: x_{i-1},\: x_i+h,\: x_{i+1},\: \ldots,\: x_n) - f(x_1,\: \ldots,\: x_i,\: \dots,\: x_n)}{h}
    \end{equation*}
\end{definition}

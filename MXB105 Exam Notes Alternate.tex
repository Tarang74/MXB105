...
\begin{multicols}{3}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.5]
            ...
            \draw (A) -- node[above]{\( a \)}
            (B) -- node[right]{\( b x \)}
            (C) -- node[below]{\( \sqrt{a^2-b^2x^2} \)}(A);
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.5]
            ...
            \coordinate (B) at (1.5cm,1.0cm);
            \coordinate (C) at (1.5cm,-1.0cm);
            \draw (A) -- node [above, rotate=33] {\( \sqrt{a^2+b^2x^2} \)} (B);
            \draw (B) -- node[right]{\( bx \)} (C);
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.5]
            ...
            \coordinate (B) at (1.5cm,1.0cm);
            \coordinate (C) at (1.5cm,-1.0cm);
            \draw (A) -- node[above]{\( bx \)}
            (B) -- node[below, rotate=90]{\( \sqrt{b^2x^2-a^2} \)}
            (C) -- node[below]{\( a \)}(A);
            \draw (C) -- (A) -- (B) pic [draw,angle radius=9mm,"\( \theta \)"]
                {angle=C--A--B};
            \draw (1.25cm,-1.0cm) rectangle (1.5cm,-0.75cm);
